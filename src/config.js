...
const defaultConfig = {
  ...
  disable100pcUpload: false, // Default value
  ...
  try {
    ...
    const normalizedConfig = {
      ...
      ...(config.disableSmallUpload !== undefined && {
       ...
       // Handle disable100pcUpload (accept both string and boolean)

      ...(config.disable100pcUpload !== undefined && {

        disable100pcUpload: config.disable100pcUpload === 'true' || config.disable100pcUpload === true
...
const config = {
  ...
  get disable100pcUpload() { 

    return runtimeConfig.disable100pcUpload !== undefined 

      ? runtimeConfig.disable100pcUpload 

      : defaultConfig.disable100pcUpload; 
